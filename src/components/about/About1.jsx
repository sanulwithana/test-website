            ...
            <div className="tf-container">
                <div className="row ">
                    <div className="col-md-12 ">
                        ...
                        <div style={{ flex: 1, justifyContent: 'center', }} className="counter-wrap" data-wow-delay="0.2s">
                            <Grid  container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} style={{ justifyContent: 'center', zIndex: 30, }}>
                                {
                                    stats.map(idx => (
                                        <>
                                            <Grid item xs={4} md={3} >
                                                <Item>
                                                    <h5>{idx.heading}</h5>
                                                    <h3 style={{ fontSize: "4rem", fontWeight: "600" }}  >{idx.count}+</h3>
                                                </Item>
                                            </Grid>
                                        </>
                        ...
                        data.map((idx, index) => (
                            <div key={index} className="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12" style={{ marginBottom: '2rem' }}>
                                <div className="tf-step wow fadeInUp" data-wow-delay="0.2s" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                                    ...
                                    <p style={{ fontSize: '1.5rem', lineHeight: '1.4' ,fontWeight:"400"}}>{idx.description}</p>
                                </div>
                            </div>
